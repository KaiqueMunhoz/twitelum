...
class Tweet extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            isLiked: props.tweetInfo.likeado,
        ...
        return (
            <article className="tweet">
                ...
                <footer className="tweet__footer">
                    <button className="btn btnHeart btn--clean" onClick={this.likeHandler}>
                        <svg className={`icon icon--small iconHeart ${ this.state.isLiked ? 'iconHeart--active' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.5 47.5">
                            <defs>  
                                <clipPath id="a">
